      ...
      <div className="page-width contact-layout">
        <Reveal className="contact-main">
          <span className="contact-label">
            <i aria-hidden="true" /> Start a conversation
          </span>

          <h2 id="contact-heading">
            Have a system that needs to{' '}
            <em>sense, decide,</em> or move?
          </h2>

          <p>
            I’m always interested in thoughtful conversations around
            mechatronics, embedded systems, automation, and connected products.
          </p>
